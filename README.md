...
- [ ] Indexação completa do vídeos longos: 
  - [X] ~~[CURSO INTENSIVO de React e Next 13](#CURSO-INTENSIVO-de-React-e-Next-13)~~ (mais detalhes veja [aqui](docs/indexacoes/REAMDME.md)). Vídeo longo totalmente indexada e relacionada com os questionários de contextos!
