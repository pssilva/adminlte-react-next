...
- [X] ~~Indexação da playlist completamente finalizada: [CURSO INTENSIVO de React e Next 13](#CURSO-INTENSIVO-de-React-e-Next-13)~~ (mais detalhes veja [aqui](docs/indexacoes/REAMDME.md))
